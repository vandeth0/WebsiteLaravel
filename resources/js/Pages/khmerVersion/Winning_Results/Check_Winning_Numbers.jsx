    ...
    return (
      <>
        ...
        <div className="container-fluid font-khmer-language">
          <div className="container">
            <div className="row">
              ...
              <div className="col-12 text-center">
                <h4>ពិនិត្យមើលលទ្ធផលគ្រាប់ឡូតូ</h4>
              </div>
              ...
              <input
                ...
                className="d-none"
              />
              <div className="Choose-your-ball-number font-khmer-language">
                  ...
                  <ul>
                    {chooseBall.map((item, idx) => {
                      return (
                        <li key={idx}>
                          <button
                            style={{ fontFamily: 'AKbalthom Kbach' }}
                            disabled={numberSameValue[idx] == 1 ? true : false}
                            className="btn btn-dark border my-1"
                            onClick={(e) => {
                              e.stopPropagation();
          ...
          <div className="row p-5" style={{ background: '#f1f2f2' }}>
            <div className="col-12">
              <div className="container">
                <div className="row">
                  <div className="col-12 text-center">
