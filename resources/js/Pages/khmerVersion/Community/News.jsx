...
import NewsShow from 'Pages/Community/NewsShow';
import NewsEdit from 'Pages/Community/NewsEdit';
...
export default class News extends Component {
  ...
  render() {
    const { newsList, newsListNext, previousNews, NextNews } = this.store;
